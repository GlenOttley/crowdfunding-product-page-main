...
function App() {
  ...
  const togglePledgeModal = (e) => {
    showPledgeModal ? setShowPledgeModal(false) : setShowPledgeModal(true)
    if (e.target.id) {
      selectProduct(e)
    }
  }
  ...
  const toggleThanksModal = () => {
    showThanksModal ? setShowThanksModal(false) : setShowThanksModal(true)
  }
  ...
  return (
    <div className='App'>
      ...
      <NavModal showNavModal={showNavModal} toggleNavModal={toggleNavModal} />
      ...
      <Menu showNav={showNavModal} toggleNavModal={toggleNavModal} />
